...
* ❌ **FORBIDDEN:** Creating .md files in `/path/to/project/` (except README.md, CLAUDE.md)
* ❌ **FORBIDDEN:** Creating .md files in `/path/to/project/src/backend/` (except README.md)
* ❌ **FORBIDDEN:** Creating .md files in `/path/to/project/AINative-website/` (except README.md, CLAUDE.md)
* ❌ **FORBIDDEN:** Creating scripts (.sh) in `/path/to/project/src/backend/` (except start.sh)

### REQUIRED LOCATIONS

## Backend Documentation → `/path/to/project/docs/`
...
## Frontend Documentation → `/path/to/project/AINative-website/docs/`
