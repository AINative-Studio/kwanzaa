...
* **Schema Sync Script:** `/path/to/project/scripts/sync-production-schema.py`
* **Documentation:** `/path/to/project/docs/deployment/SCHEMA_SYNC_GUIDE.md`
* **Alembic Migrations (for documentation):** `/path/to/project/src/backend/alembic/versions/`
