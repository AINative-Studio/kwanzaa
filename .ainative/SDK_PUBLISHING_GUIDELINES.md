...
- **Location:** `/path/to/project/sdks/python`
...
```bash
cd /path/to/project/sdks/python
...
- **Location:** `/path/to/project/sdks/typescript/zerodb-mcp-client`
...
#### Step 1: Pre-Flight Testing
```bash
cd /path/to/project/sdks/typescript/zerodb-mcp-client
