...
Generate a comprehensive daily growth report for yesterday (or specified date) following the exact workflow documented in `/path/to/project/docs/reports/DAILY_REPORT_WORKFLOW.md`.
...
Connect using `DATABASE_PUBLIC_URL` from `/path/to/project/src/backend/.env`
...
`/path/to/project/docs/reports/DAILY_GROWTH_REPORT_[DATE].md`
...
✅ Report generated: /path/to/project/docs/reports/DAILY_GROWTH_REPORT_2025-12-28.md
...
- Workflow Documentation: `/path/to/project/docs/reports/DAILY_REPORT_WORKFLOW.md`
- Example Report: `/path/to/project/docs/reports/DAILY_GROWTH_REPORT_2025-12-28.md`
- MCP Query Reference: `/path/to/project/docs/reports/MCP_QUERY_REFERENCE.md`
- Project Rules: `/path/to/project/.claude/CLAUDE.md` (Rule 4: Data Gathering - MCP FIRST)
